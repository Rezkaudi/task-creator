...
export type UIMessage =
  ...
  | { type: 'ai-chat-response'; designData: any; previewHtml?: string | null; cost?: CostInfo; points?: PointsInfo }
  ...
  | { type: 'ai-edit-response'; designData: any; previewHtml?: string | null; cost?: CostInfo; points?: PointsInfo }
  | { type: 'ai-edit-error'; error: string; statusCode?: number }
  | { type: 'ai-based-on-existing-response'; designData: any; previewHtml?: string | null; cost?: CostInfo; points?: PointsInfo }
